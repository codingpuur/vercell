...
let  instance = new Razorpay({ key_id:"rzp_test_sXArJAhc492VDU", key_secret: "iBBeEAPjYTKTKoXwjiVZ6Ep4" })
...
instance.orders.create(options, function(err, order) {
  ...
  return res.send({code:200, massage:"order created",data:order})
...
module.exports.verify=(req,res)=>{
        ...
        let body=req.body.response.razorpay_order_id + "|" + req.body.response.razorpay_payment_id;
         ...
         var expectedSignature = crypto.createHmac('sha256', 'iBBeEAPjYTKTKoXwjiVZ6Ep4')
    ...
    res.send({code:200, massage:"sing valid"});
}else{
    res.send({code:500, massage:"sing invalid"});
}
